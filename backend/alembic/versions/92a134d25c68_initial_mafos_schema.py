"""initial_mafos_schema

Revision ID: 92a134d25c68
Revises: 
Create Date: 2026-05-13 21:54:48.071004
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('SUPER_ADMIN', 'VENDOR_OWNER', 'MASTER_ADMIN', 'COLLECTION_OFFICER', name='userrole'), nullable=True),
    sa.Column('vendor_id', sa.String(), nullable=True),
    sa.ForeignKeyConstraint(['vendor_id'], ['vendors.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
